...
Register_Class(IbanPaquete)

IbanPaquete::IbanPaquete(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->initTime = 0;
    this->nodeInitTime = 0;
    this->hopNum = 0;
...
IbanPaquete::~IbanPaquete()
{
}

IbanPaquete& IbanPaquete::operator=(const IbanPaquete& other)
{
...
void IbanPaquete::copy(const IbanPaquete& other)
{
...
void IbanPaquete::setInitTime(double initTime)
{
    this->initTime = initTime;
}

double IbanPaquete::getNodeInitTime() const
{
    return this->nodeInitTime;
}
...
class IbanPaqueteDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    IbanPaqueteDescriptor();
    virtual ~IbanPaqueteDescriptor();
...
Register_ClassDescriptor(IbanPaqueteDescriptor)

IbanPaqueteDescriptor::IbanPaqueteDescriptor() : omnetpp::cClassDescriptor("IbanPaquete", "omnetpp::cPacket")
{
    propertynames = nullptr;
}

IbanPaqueteDescriptor::~IbanPaqueteDescriptor()
{
    delete[] propertynames;
}

bool IbanPaqueteDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<IbanPaquete *>(obj)!=nullptr;
}

const char **IbanPaqueteDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *IbanPaqueteDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *IbanPaqueteDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *IbanPaqueteDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int IbanPaqueteDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    IbanPaquete *pp = (IbanPaquete *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *IbanPaqueteDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string IbanPaqueteDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool IbanPaqueteDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *IbanPaqueteDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *IbanPaqueteDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
