 ...
 */
class TicSaW : public cSimpleModule
{
  private:
...
void TicSaW::handleMessage(cMessage *msg)
{
    if (msg == timeoutEvent) {
...
cMessage *TicSaW::generateNewMessage()
{
...
void TicSaW::sendCopyOf(cMessage *msg)
{
 ...
 */
class TocSaW : public cSimpleModule
{
  protected:
    virtual void handleMessage(cMessage *msg) override;
};

Define_Module(TocSaW);

void TocSaW::handleMessage(cMessage *msg)
{
    if (uniform(0, 1) < 0.1) {
